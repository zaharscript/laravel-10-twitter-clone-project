    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-6">
                <h1>TERM</h1>
                <hr>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut deserunt adipisci, esse modi fugit, aliquid
                    corporis
                    quasi, laboriosam nesciunt saepe quisquam ad omnis iusto obcaecati aliquam consequuntur iure. Ipsum, ea!
                </p>
            </div>
            {{-- end main content --}}
            {{-- start right sidebar --}}
